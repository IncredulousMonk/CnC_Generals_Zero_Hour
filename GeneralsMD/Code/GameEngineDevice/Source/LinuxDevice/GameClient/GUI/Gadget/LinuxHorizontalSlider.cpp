...
// LinuxGadgetHorizontalSliderDraw ============================================
/** Draw colored horizontal slider using standard graphics */
//=============================================================================
void LinuxGadgetHorizontalSliderDraw( GameWindow *window, WinInstanceData *instData )
{
...
}  // end LinuxGadgetHorizontalSliderDraw

// LinuxGadgetHorizontalSliderImageDraw =======================================
/** Draw horizontal slider with user supplied images */
//=============================================================================
void LinuxGadgetHorizontalSliderImageDraw( GameWindow *window, WinInstanceData *instData )
{
   ...
   if( BitTest( instData->getState(), WIN_STATE_HILITED ) )
   {
      ...
      for (i=0; i<numHighlightBoxes; ++i)
      {
         ...
         TheWindowManager->winDrawImage( highlightSquare, backgroundStart.x, backgroundStart.y, backgroundEnd.x, backgroundEnd.y );
      }
   }
...
/** Draw horizontal slider with user supplied images */
//=============================================================================
void LinuxGadgetHorizontalSliderImageDrawB( GameWindow *window, WinInstanceData *instData )
{
...
/** Draw horizontal slider with user supplied images */
//=============================================================================
void LinuxGadgetHorizontalSliderImageDrawA( GameWindow *window, WinInstanceData *instData )
{
...
//    smallCenterImageRight = smallCenterImageLeft = GadgetSliderGetDisabledImageSmallCenter( window );
   ...
   for( i = 0; i < pieces; i++ )
   {
      ...
      TheWindowManager->winDrawImage( centerImageLeft, start.x, start.y, end.x, end.y );
      TheDisplay->setClipRegion(&clipRight);
      TheWindowManager->winDrawImage( centerImageRight, start.x, start.y, end.x, end.y );
   ...
   for( i = 0; i < pieces; i++ )
   {
      ...
      TheDisplay->setClipRegion(&clipLeft);
      TheWindowManager->winDrawImage( smallCenterImageLeft, start.x, start.y, end.x, end.y );
      TheDisplay->setClipRegion(&clipRight);
      TheWindowManager->winDrawImage( smallCenterImageRight, start.x, start.y, end.x, end.y );
...
}  // end LinuxGadgetHorizontalSliderImageDraw
