...
Int	IMECandidateWindowLineSpacing;
...
class IMEManager : public IMEManagerInterface
{
	...
	public:
		...
		// No copies allowed!
		IMEManager(const IMEManager&) = delete;
		IMEManager& operator=(const IMEManager&) = delete;
...
// //		cy = 0;
// 	cx = static_cast<Int>(TheDisplay->getWidth()) - cwidth;
// 	cy = 0;
// 	updateProperties();
