...
{
public:
	// MG: Cannot apply offsetof to FireWeaponCollideModuleData, so had to move data into an embedded struct.
	struct IniData
	{
	...
	{
		m_ini.m_collideWeaponTemplate = NULL;
		m_ini.m_fireOnce = FALSE;
	}

	// No copies allowed!
	FireWeaponCollideModuleData(const FireWeaponCollideModuleData&) = delete;
	FireWeaponCollideModuleData& operator=(const FireWeaponCollideModuleData&) = delete;
...
public:
	...
	// No copies allowed!
	FireWeaponCollide(const FireWeaponCollide&) = delete;
	FireWeaponCollide& operator=(const FireWeaponCollide&) = delete;
