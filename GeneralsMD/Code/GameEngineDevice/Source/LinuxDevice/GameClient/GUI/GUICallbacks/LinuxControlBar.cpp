...
#if 0
//-------------------------------------------------------------------------------------------------
void LinuxCameoMovieDraw( GameWindow *window, WinInstanceData *instData )
{
   // draw video buffer
...
}  // end LinuxLeftHUDDraw


//-------------------------------------------------------------------------------------------------
void LinuxLeftHUDDraw( GameWindow *window, WinInstanceData *instData )
{
...
//
   ...
   {
      ICoord2D pos, size;
      //LinuxGameWinDefaultDraw( window, instData );
...
//-------------------------------------------------------------------------------------------------
//-------------------------------------------------------------------------------------------------
void LinuxRightHUDDraw( GameWindow *window, WinInstanceData *instData )
{
...
//-------------------------------------------------------------------------------------------------
void LinuxPowerDraw( GameWindow *window, WinInstanceData *instData )
{
...
void LinuxPowerDrawA( GameWindow *window, WinInstanceData *instData )
{
   static const Image *endBarYellow = TheMappedImageCollection->findImageByName("PowerBarYellowEndR");
   static const Image *beginBarYellow = TheMappedImageCollection->findImageByName("PowerBarYellowEndL");
...
void LinuxCommandBarGridDraw( GameWindow *window, WinInstanceData *instData )
{
   if( BitTest(window->winGetStatus(), WIN_STATUS_IMAGE ))
   {
      LinuxGameWinDefaultDraw( window, instData );
...
void LinuxCommandBarGenExpDraw( GameWindow *window, WinInstanceData *instData )
{
   Player *player = ThePlayerList->getLocalPlayer();
...
void LinuxCommandBarTopDraw( GameWindow *window, WinInstanceData *instData )
{
...
void LinuxCommandBarBackgroundDraw( GameWindow *window, WinInstanceData *instData )
{
...
void LinuxCommandBarForegroundDraw( GameWindow *window, WinInstanceData *instData )
{
...
void LinuxDrawMapPreview( GameWindow *window, WinInstanceData *instData)
{
...
void LinuxCommandBarHelpPopupDraw( GameWindow *window, WinInstanceData *instData )
{
