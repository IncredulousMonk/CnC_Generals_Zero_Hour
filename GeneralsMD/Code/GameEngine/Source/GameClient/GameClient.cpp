 ...
 */
void GameClient::iterateDrawablesInRegion( [[maybe_unused]] Region3D *region, [[maybe_unused]] GameClientFuncPtr userFunc, [[maybe_unused]] void *userData )
{
...
Bool GameClient::loadMap( [[maybe_unused]] AsciiString mapName )
{
...
void GameClient::unloadMap( [[maybe_unused]] AsciiString mapName )
{
...
//-------------------------------------------------------------------------------------------------
void GameClient::setTimeOfDay( [[maybe_unused]] TimeOfDay tod )
{
	// Drawable *draw = firstDrawable();
...
//-------------------------------------------------------------------------------------------------
void GameClient::assignSelectedDrawablesToGroup( [[maybe_unused]] Int group )
{
/*
	Drawable *draw = firstDrawable();
	while( draw )
...
//-------------------------------------------------------------------------------------------------
void GameClient::selectDrawablesInGroup( [[maybe_unused]] Int group )
{
/*
	Drawable *draw = firstDrawable();
...
// ------------------------------------------------------------------------------------------------
void GameClient::addTextBearingDrawable( [[maybe_unused]] Drawable *tbd )
{
	// if ( tbd != NULL )
...
void GameClient::getRayEffectData( [[maybe_unused]] Drawable *draw, [[maybe_unused]] RayEffectData *effectData )
{
...
void GameClient::removeFromRayEffects( [[maybe_unused]] Drawable *draw )
{
...
// ------------------------------------------------------------------------------------------------
void GameClient::xferDrawableTOC( [[maybe_unused]] Xfer *xfer )
{
 ...
 */
// ------------------------------------------------------------------------------------------------
void GameClient::xfer( [[maybe_unused]] Xfer *xfer )
{
