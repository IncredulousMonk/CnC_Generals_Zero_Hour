...
#ifndef __LINUXTERRAINVISUAL_H_
#define __LINUXTERRAINVISUAL_H_

#include "GameClient/TerrainVisual.h"
// #include "LinuxDevice/GameClient/LinuxWater.h"
#include "WWLib/refcount.h" // MG: Maybe can remove after dummy classes below are worked out.
...
class WaterRenderObjClass: public RefCountClass
{
   // FIXME: Dummy class for the moment.
};

//-------------------------------------------------------------------------------------------------
/** Linux implementation of visual terrain details singleton */
//-------------------------------------------------------------------------------------------------
class LinuxTerrainVisual: public TerrainVisual
{

public:

   LinuxTerrainVisual();
   virtual ~LinuxTerrainVisual();

   // No copies allowed!
   LinuxTerrainVisual(const LinuxTerrainVisual&) = delete;
   LinuxTerrainVisual& operator=(const LinuxTerrainVisual&) = delete;
...
protected:
   ...
   BaseHeightMapRenderObjClass* m_terrainRenderObject {};  ///< Linux render object for terrain
   WaterRenderObjClass* m_waterRenderObject {}; ///< Linux render object for water plane
...
};  // end class LinuxTerrainVisual

#endif  // end __LINUXTERRAINVISUAL_H_
