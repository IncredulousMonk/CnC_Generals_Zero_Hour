...
TerrainTextureClass::TerrainTextureClass(int height) :
	TextureClass(TEXTURE_WIDTH, (unsigned int)height, 
...
TerrainTextureClass::TerrainTextureClass(int height, int width) :
	TextureClass((unsigned int)width, (unsigned int)height, 
...
{
(void) LOD;
DEBUG_CRASH(("TerrainTextureClass::setLOD not yet implemented!"));
#if 0
...
(void) cellWidth;
(void) pixelsPerCell;
DEBUG_CRASH(("TerrainTextureClass::updateFlat not yet implemented!"));
return false;
#if 0
	// D3DTexture is our texture;
...
{
(void) stage;
DEBUG_CRASH(("TerrainTextureClass::Apply not yet implemented!"));
#if 0
	// Do the base apply.
	TextureClass::Apply(stage);
...
//	TextureClass("EdgingTemplate.tga","EdgingTemplate.tga", mipLevelCount )
	TextureClass(TEXTURE_WIDTH, (unsigned int)height, WW3D_FORMAT_A8R8G8B8, mipLevelCount )
{ 
...
{
DEBUG_CRASH(("CloudMapTerrainTextureClass::restore not yet implemented!"));
#if 0
	DX8Wrapper::Set_DX8_Texture_Stage_State( 0, D3DTSS_COLORARG1, D3DTA_TEXTURE );
	DX8Wrapper::Set_DX8_Texture_Stage_State( 0, D3DTSS_COLORARG2, D3DTA_DIFFUSE );
	DX8Wrapper::Set_DX8_Texture_Stage_State( 0, D3DTSS_COLOROP,   D3DTOP_MODULATE );
...
{
(void) stage;
DEBUG_CRASH(("ScorchTextureClass::Apply not yet implemented!"));
#if 0
	// Do the base apply.
	TextureClass::Apply(stage);
