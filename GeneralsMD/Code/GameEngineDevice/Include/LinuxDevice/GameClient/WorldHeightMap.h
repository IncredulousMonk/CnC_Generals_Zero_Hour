...
protected:
	...
	Int m_numBlendedTiles {1};	// Number of blended tiles created from bitmap tiles.
	...
	Int m_numCliffInfo {1}; ///< Number of cliffInfo's used in m_cliffInfo.
	...
	Int	m_terrainTexHeight {1}; /// Height of m_terrainTex allocated.
	...
	Int	m_alphaTexHeight {1}; /// Height of m_alphaTerrainTex allocated.
	...
	Int m_drawOriginX {};
	Int m_drawOriginY {};
	Int m_drawWidthX {NORMAL_DRAW_WIDTH};
	Int m_drawHeightY {NORMAL_DRAW_HEIGHT};
...
public: // constructors/destructors
	...
	// No copies allowed!
	WorldHeightMap(const WorldHeightMap&) = delete;
	WorldHeightMap& operator=(const WorldHeightMap&) = delete;
