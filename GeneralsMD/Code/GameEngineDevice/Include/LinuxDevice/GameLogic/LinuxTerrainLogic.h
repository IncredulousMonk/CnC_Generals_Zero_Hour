...
#ifndef __LINUXTERRAINLOGIC_H_
#define __LINUXTERRAINLOGIC_H_

#include "GameLogic/TerrainLogic.h"

//-------------------------------------------------------------------------------------------------
/** Linux specific implementation details for logical terrain ... we have this
...
//-------------------------------------------------------------------------------------------------
class LinuxTerrainLogic: public TerrainLogic
{

public:

   LinuxTerrainLogic();
   virtual ~LinuxTerrainLogic();
...
#endif  // end __LINUXTERRAINLOGIC_H_
