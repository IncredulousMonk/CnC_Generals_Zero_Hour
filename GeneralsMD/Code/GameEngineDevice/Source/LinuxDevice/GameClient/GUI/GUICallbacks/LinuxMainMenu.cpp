...
#if 0
void LinuxMainMenuDraw( GameWindow *window, WinInstanceData *instData )
{
...
void LinuxMainMenuFourDraw( GameWindow *window, WinInstanceData *instData )
{
   //LinuxGameWinDefaultDraw( window, instData );
...
void LinuxMetalBarMenuDraw( GameWindow *window, WinInstanceData *instData )
{
...
void LinuxClockDraw( GameWindow *window, WinInstanceData *instData )
{
   LinuxGameWinDefaultDraw( window, instData );
   ICoord2D pos, size;
...
#if 0
void LinuxMainMenuMapBorder( GameWindow *window, WinInstanceData *instData )
{
   enum
   {
...
// LinuxMainMenuButtonDropShadowDraw ===============================================
/** Draw pushbutton with user supplied images */
//=============================================================================
void LinuxMainMenuButtonDropShadowDraw( GameWindow *window, 
...
// LinuxMainMenuRandomTextDraw ==================================================
/** Specialized drawing function for the random text */
//=============================================================================
void LinuxMainMenuRandomTextDraw( GameWindow *window, WinInstanceData *instData )
{
...
void LinuxThinBorderDraw( GameWindow *window, WinInstanceData *instData )
{
   ICoord2D start, size;
   const Image *image;
