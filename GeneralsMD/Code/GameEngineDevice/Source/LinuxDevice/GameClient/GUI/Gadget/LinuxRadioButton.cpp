...
// LinuxGadgetRadioButtonDraw ===================================================
/** Draw colored check box using standard graphics */
//=============================================================================
void LinuxGadgetRadioButtonDraw( GameWindow *window, WinInstanceData *instData )
{
...
}  // end LinuxGadgetRadioButtonDraw


void LinuxGadgetRadioButtonImageDraw( GameWindow *window, WinInstanceData *instData )
{
