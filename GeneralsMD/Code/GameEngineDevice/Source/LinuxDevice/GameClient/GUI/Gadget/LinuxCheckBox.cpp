...
// LinuxGadgetCheckBoxDraw ====================================================
/** Draw colored check box using standard graphics */
//=============================================================================
void LinuxGadgetCheckBoxDraw( GameWindow *window, WinInstanceData *instData )
{
...
}  // end LinuxGadgetCheckBoxDraw

// LinuxGadgetCheckBoxImageDraw ===============================================
/** Draw check box with user supplied images */
//=============================================================================
void LinuxGadgetCheckBoxImageDraw( GameWindow *window, WinInstanceData *instData )
{
   Int checkOffsetFromLeft;
...
// if( backgroundImage )
//    TheWindowManager->winDrawImage( backgroundImage, start.x, start.y, end.x, end.y );
...
}  // end LinuxGadgetCheckBoxImageDraw
