...
protected:
   ...
   */
   class CameraShakerClass : public MultiListObjectClass //, public AutoPoolClass<CameraShakerClass,256> // MG: The DynamicMemoryAllocator should take care of pooling.
   {
   public:
