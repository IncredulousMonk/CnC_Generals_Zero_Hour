...
// LinuxGadgetProgressBarDraw =================================================
/** Draw colored Progress Bar using standard graphics */
//=============================================================================
void LinuxGadgetProgressBarDraw( GameWindow *window, WinInstanceData *instData )
{
...
//       TheWindowManager->winOpenRect( barColor, WIN_DRAW_LINE_WIDTH, start.x, start.y, end.x, end.y );
...
}  // end LinuxGadgetProgressBarDraw
...
// Int height = barCenter->getImageHeight();
   ...
   for( i = 0; i < pieces; i ++)
   {
      TheWindowManager->winDrawImage( barCenter, x, origin.y, x + width, origin.y + size.y );
      x += width;
   }
...
void LinuxGadgetProgressBarImageDraw( GameWindow *window, WinInstanceData *instData )
{
   ICoord2D origin, size, start, end;
...
}  // end LinuxGadgetProgressBarImageDraw
