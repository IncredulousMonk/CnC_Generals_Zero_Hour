...
LinuxParticleSystemManager::LinuxParticleSystemManager()
{
   // m_pointGroup = NULL;
   // m_streakLine = NULL;
   // m_posBuffer = NULL;
   ...
   // m_posBuffer = NEW_REF( ShareBufferClass<Vector3>, (MAX_POINTS_PER_GROUP, "LinuxParticleSystemManager::m_posBuffer") );
   // m_RGBABuffer = NEW_REF( ShareBufferClass<Vector4>, (MAX_POINTS_PER_GROUP, "LinuxParticleSystemManager::m_RGBABuffer") );
   // m_sizeBuffer = NEW_REF( ShareBufferClass<float>, (MAX_POINTS_PER_GROUP, "LinuxParticleSystemManager::m_sizeBuffer") );
   // m_angleBuffer = NEW_REF( ShareBufferClass<uint8>, (MAX_POINTS_PER_GROUP, "LinuxParticleSystemManager::m_angleBuffer") );
}
 ...
 */
void LinuxParticleSystemManager::queueParticleRender()
{
...
void LinuxParticleSystemManager::doParticles(RenderInfoClass &rinfo)
{
