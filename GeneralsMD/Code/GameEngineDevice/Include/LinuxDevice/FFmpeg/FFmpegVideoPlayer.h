...
#ifndef __FFMPEGVIDEOPLAYER_H
#define __FFMPEGVIDEOPLAYER_H
...
class FFmpegVideoStream: public VideoStream {
   ...
   protected:
      ...
      // No copies allowed!
      FFmpegVideoStream(const FFmpegVideoStream&) = delete;
      FFmpegVideoStream& operator=(const FFmpegVideoStream&) = delete;
...
class FFmpegVideoPlayer: public VideoPlayer {
   ...
   protected:
      ...
      VideoStreamInterface* createStream(FFmpegVideo* video);
