...
void LinuxInGameUI::draw() {
   ...
   if (TheDisplay) {
      ...
      for (view = TheDisplay->getFirstView(); view; view = TheDisplay->getNextView(view)) {
         // draw move hints
         drawMoveHints( view );
...
//-------------------------------------------------------------------------------------------------
void LinuxInGameUI::drawSelectionRegion( void )
{
   Real width = 2.0f;
...
/** Draw the visual feedback for clicking in the world and telling units
   * to move there */
//-------------------------------------------------------------------------------------------------
void LinuxInGameUI::drawMoveHints( View *view )
{
   Int i;
//	Real width = 1.0f;
//	UnsignedInt color = 0x9933FF33;  //0xAARRGGBB
...
//-------------------------------------------------------------------------------------------------
void LinuxInGameUI::drawAttackHints( View *view )
{
...
//-------------------------------------------------------------------------------------------------
void LinuxInGameUI::drawPlaceAngle( View *view )
{
//	Coord2D v, p, o;
   //Real size = 15.0f;
