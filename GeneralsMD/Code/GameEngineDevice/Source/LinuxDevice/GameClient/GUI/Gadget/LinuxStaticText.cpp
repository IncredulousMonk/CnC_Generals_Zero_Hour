...
static void drawStaticTextText( GameWindow* window, WinInstanceData* /* instData */, Color textColor, Color textDropColor )
{
   ...
   if( BitTest( window->winGetStatus(), WIN_STATUS_HOTKEY_TEXT ) && TheGlobalData)
      text->setUseHotkey(TRUE, TheGlobalData->m_data.m_hotKeyTextColor);
   else
...
// LinuxGadgetStaticTextDraw ==================================================
/** Draw colored text field using standard graphics */
//=============================================================================
void LinuxGadgetStaticTextDraw( GameWindow *window, WinInstanceData *instData )
{
   TextData *tData = (TextData *)window->winGetUserData();
...
}  // end LinuxGadgetStaticTextDraw

// LinuxGadgetStaticTextImageDraw =============================================
/** Draw colored text field with user supplied images */
//=============================================================================
void LinuxGadgetStaticTextImageDraw( GameWindow *window, WinInstanceData *instData )
{
   TextData *tData = (TextData *)window->winGetUserData();
...
}  // end LinuxGadgetStaticTextImageDraw
