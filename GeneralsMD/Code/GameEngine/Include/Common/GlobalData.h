...
public:
	...
	// MG: Cannot apply offsetof to GlobalData, so had to move data into an embedded struct.
	struct Data
	{
		...
		Bool m_windowed;
		UnsignedInt m_xResolution;
		UnsignedInt m_yResolution;
		...
		Int m_firewallBehavior;	///< Last detected firewall behavior
