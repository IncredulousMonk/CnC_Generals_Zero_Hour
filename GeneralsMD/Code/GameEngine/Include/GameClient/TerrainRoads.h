...
public:
	...
	inline AsciiString getTexture( void ) { return m_ini.m_texture; }
	inline Bool isBridge( void ) { return m_isBridge; }
	inline UnsignedInt getID( void ) { return m_id; }

	inline Real getRoadWidth( void ) { return m_ini.m_roadWidth; }
	inline Real getRoadWidthInTexture( void ) { return m_ini.m_roadWidthInTexture; }

	inline Real getBridgeScale( void ) { return m_ini.m_bridgeScale; }
	inline AsciiString getScaffoldObjectName( void ) { return m_ini.m_scaffoldObjectName; }
	inline AsciiString getScaffoldSupportObjectName( void ) { return m_ini.m_scaffoldSupportObjectName; }
	inline RGBColor getRadarColor( void ) { return m_ini.m_radarColor; }
	inline AsciiString getBridgeModel( void ) { return m_ini.m_bridgeModelName; }
	inline AsciiString getBridgeModelNameDamaged( void ) { return m_ini.m_bridgeModelNameDamaged; }
	inline AsciiString getBridgeModelNameReallyDamaged( void ) { return m_ini.m_bridgeModelNameReallyDamaged; }
	inline AsciiString getBridgeModelNameBroken( void ) { return m_ini.m_bridgeModelNameBroken; }
	inline AsciiString getTextureDamaged( void ) { return m_ini.m_textureDamaged; }
	inline AsciiString getTextureReallyDamaged( void ) { return m_ini.m_textureReallyDamaged; }
	inline AsciiString getTextureBroken( void ) { return m_ini.m_textureBroken; }
	inline AsciiString getTowerObjectName( BridgeTowerType tower ) { return m_ini.m_towerObjectName[ tower ]; }
	inline AsciiString getDamageToSoundString( BodyDamageType state ) { return m_ini.m_damageToSoundString[ state ]; }
	inline AsciiString getDamageToOCLString( BodyDamageType state, Int index ) { return m_ini.m_damageToOCLString[ state ][ index ]; }
	inline AsciiString getDamageToFXString( BodyDamageType state, Int index ) { return m_ini.m_damageToFXString[ state ][ index ]; }
	inline AsciiString getRepairedToSoundString( BodyDamageType state ) { return m_ini.m_repairedToSoundString[ state ]; }
	inline AsciiString getRepairedToOCLString( BodyDamageType state, Int index ) { return m_ini.m_repairedToOCLString[ state ][ index ]; }
	inline AsciiString getRepairedToFXString( BodyDamageType state, Int index ) { return m_ini.m_repairedToFXString[ state ][ index ]; }
	inline Real getTransitionEffectsHeight( void ) { return m_ini.m_transitionEffectsHeight; }
	inline Int getNumFXPerType( void ) { return m_ini.m_numFXPerType; }

	// friend access methods to be used by the road collection only!
	inline void friend_setName( AsciiString name ) { m_name = name; }
	inline void friend_setTexture( AsciiString texture ) { m_ini.m_texture = texture; }
	...
	inline void friend_setRoadWidth( Real width ) { m_ini.m_roadWidth = width; }	
	inline void friend_setRoadWidthInTexture( Real width ) { m_ini.m_roadWidthInTexture = width; }
	inline void friend_setBridgeScale( Real scale ) { m_ini.m_bridgeScale = scale; }
	inline void friend_setScaffoldObjectName( AsciiString name ) { m_ini.m_scaffoldObjectName = name; }
	inline void friend_setScaffoldSupportObjectName( AsciiString name ) { m_ini.m_scaffoldSupportObjectName = name; }
	inline void friend_setBridgeModelName( AsciiString name ) { m_ini.m_bridgeModelName = name; }
	inline void friend_setBridgeModelNameDamaged( AsciiString name ) { m_ini.m_bridgeModelNameDamaged = name; }
	inline void friend_setBridgeModelNameReallyDamaged( AsciiString name ) { m_ini.m_bridgeModelNameReallyDamaged = name; }
	inline void friend_setBridgeModelNameBroken( AsciiString name ) { m_ini.m_bridgeModelNameBroken = name; }
	inline void friend_setTextureDamaged( AsciiString texture ) { m_ini.m_textureDamaged = texture; }
	inline void friend_setTextureReallyDamaged( AsciiString texture ) { m_ini.m_textureReallyDamaged = texture; }
	inline void friend_setTextureBroken( AsciiString texture ) { m_ini.m_textureBroken = texture; }
	inline void friend_setTowerObjectName( BridgeTowerType tower, AsciiString name ) { m_ini.m_towerObjectName[ tower ] = name; }
	inline void friend_setDamageToSoundString( BodyDamageType state, AsciiString s ) { m_ini.m_damageToSoundString[ state ] = s; }
	inline void friend_setDamageToOCLString( BodyDamageType state, Int index, AsciiString s ) { m_ini.m_damageToOCLString[ state ][ index ] = s; }
	inline void friend_setDamageToFXString( BodyDamageType state, Int index, AsciiString s ) { m_ini.m_damageToFXString[ state ][ index ] = s; }
	inline void friend_setRepairedToSoundString( BodyDamageType state, AsciiString s ) { m_ini.m_repairedToSoundString[ state ] = s; }
	inline void friend_setRepairedToOCLString( BodyDamageType state, Int index, AsciiString s ) { m_ini.m_repairedToOCLString[ state ][ index ] = s; }
	inline void friend_setRepairedToFXString( BodyDamageType state, Int index, AsciiString s ) { m_ini.m_repairedToFXString[ state ][ index ] = s; }
	inline void friend_setTransitionEffectsHeight( Real height ) { m_ini.m_transitionEffectsHeight = height; }
	inline void friend_setNumFXPerType( Int num ) { m_ini.m_numFXPerType = num; }
...
protected:
	...
	// MG: Cannot apply offsetof to TerrainRoadType, so had to move data into an embedded struct.
	struct IniData
	{
		// road data
