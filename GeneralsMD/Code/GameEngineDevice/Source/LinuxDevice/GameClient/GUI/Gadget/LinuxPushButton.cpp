...
void LinuxGadgetPushButtonImageDrawThree(GameWindow *window, WinInstanceData *instData );
void LinuxGadgetPushButtonImageDrawOne(GameWindow *window, WinInstanceData *instData );
...
// LinuxGadgetPushButtonDraw ==================================================
/** Draw colored pushbutton using standard graphics */
//=============================================================================
void LinuxGadgetPushButtonDraw( GameWindow *window, WinInstanceData *instData )
{
   Color color, border;
...
}  // end LinuxGadgetPushButtonDraw




// LinuxGadgetPushButtonImageDraw =============================================
/** Draw pushbutton with user supplied images */
//=============================================================================
void LinuxGadgetPushButtonImageDraw( GameWindow *window, 
                                                    WinInstanceData *instData )
{
   ...
   if( GadgetButtonGetMiddleEnabledImage( window ) ) 
   {
      if( BitTest( instData->getState(), WIN_STATUS_USE_OVERLAY_STATES ) )
      {
         ...
         DEBUG_CRASH( ("Button at %d,%d is attempting to render with LinuxGadgetPushButtonImageDrawThree(), but is using overlay states! Forcing the code to use LinuxGadgetPushButtonImageDrawOne() instead.", start.x, start.y ) );
         LinuxGadgetPushButtonImageDrawOne( window, instData );
      }
      else
      {
         LinuxGadgetPushButtonImageDrawThree( window, instData );
      }
   }
   else
   {
...
void LinuxGadgetPushButtonImageDrawOne( GameWindow *window, 
                                                    WinInstanceData *instData )
{
...
}  // end LinuxGadgetPushButtonImageDraw
